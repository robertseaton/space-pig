...
you ought to be deconstructing whatever that person is doing.\marginnote{``It is not enough to succeed. Others must fail.'' -- Gore Vidal}
...
\newthought{The most important} piece of research, second only to realizing that you have a
...
direction.\marginnote{Sometimes the act of writing down a problem is enough to solve it.} They get fake internet points. You get an answer to your problem. You
both win. Or, well, you win, anyways.

\section{Librarians}

\marginnote{``When you absolutely positively have to know, ask a librarian.'' -- American Library Association}

If you can't find someone with domain expertise to help, the next step is to get
in touch with a librarian.\marginnote{“When the going gets tough, the tough get a librarian.” -- Joan Bauer}
...
interpret catalog numbers, and all of that.\marginnote{“[Librarians] are subversive. You think they're just sitting there at the desk, all quiet and everything. They're like plotting the revolution, man. I wouldn't mess with them.” -- Michael Moore}
...
For a paper, you can pull it up in \href{http://scholar.google.com/}{Google Scholar}, and click ``related
...
Vilfredo Pareto realized that 20\% of the pea pods in his garden produced 80\% of the peas. (A startling example of the pervasive inequality in the Pea Kingdom). Since then, this has been immortalized as the Pareto principle, sometimes called the principle of ``the vital few and trivial many.'' Most value is concentrated in a few exemplars. My website's most popular 3 articles account for 82\% of the total traffic.
...
with a lot of garbage that will end up being wrong in the future.\marginnote{You forget half of what you learn in medical school, and half of what they teach you turns out to be dead wrong. You just have to hope they're the same half.} So bonus.
...
Sort of like you would do with a potential date. Yeah, it's like textbook
...
\newthought{Remember, each resource} that you cut out at this stage of the
...
and\marginnote{Over the last few years, the percentage of the US population
  carrying cameras everywhere they go, every waking moment of their lives has
  gone from "almost none" to "almost all," and, with very little fanfare, we've conclusively settled the questions of flying saucers, lake monsters, ghosts, and Bigfoot.}
stuff. Don't read any of that.
\marginnote{``If anything of the classical supernatural existed, it would be a
  branch of engineering by now.'' -- Steve Gilham}
...
\item Annotated bibliographies and recommended reading lists are rhodium-level
  precious metals\footnote{$2,400 USD an ounce, twice the price of gold.}
